...
lib.ssMetadata = [
		{name:"banner_atlas_1", frames: [[0,0,468,60],[235,62,82,54],[0,62,233,24],[319,62,167,24],[319,88,50,50]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.visit.setTransform(405,30.5);
...
// library properties:
lib.properties = {
	id: '4CC58E30F911D94495E71DB05100A3DB',
	width: 468,
	height: 60,
	fps: 30,
	color: "#FFFFFF",
...
an.compositions['4CC58E30F911D94495E71DB05100A3DB'] = {
